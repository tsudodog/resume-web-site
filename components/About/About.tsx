...
const About = (props: Props) => {
    return (
        <motion.div 
            ...
            <h3 className="hidden md:block md:absolute top-24 uppercase tracking-[20px]
            ...
            <motion.img
                ...
                className='mb-10 md:mv-10flex-shrink-0 w-56 h-56 rounded-full object-cover 
            md:rounded-lg md:w-64 md:h-100 xl:w-[500px] xl:h-[600px]'
            />
            <div className="space-y-10 px-0 md:px-10">
                <h4 className="text-4xl font-semibold">Here is a <span className="underline decoration-sky-400">little</span> background </h4>
                <p className='text-sm snap-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
